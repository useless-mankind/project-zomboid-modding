...
| GitHub 仓库搜索 + `git clone` | **找原版定义的最快路径**——搜"抄了原版定义的 mod 仓库"，见[附录 B](10-数据获取与研究设施.md) |

> 现实提醒：论坛里长期有人抱怨"教程散落各处，没人讲清文件放哪"`[论坛]`。**以 pz-wiki-modding 的脚本文档 + 官方 Javadoc 为准**，视频和二手教程经常还是 B41 时代的。
>
> 这份手册本身也是**边做边记**的产物。找资料的具体手法、查 API 是否存在的流程、以及踩过的坑，都整理在 **[附录 B](10-数据获取与研究设施.md)**——**下次开新 mod 前先看那一节**。
